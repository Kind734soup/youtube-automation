...
the terminal. Nothing else in voice_generation_agent knows the difference -
...
PROMPTS_DIR = Path(__file__).resolve().parent.parent.parent / "voice_generation_agent" / "_manual_prompts"
