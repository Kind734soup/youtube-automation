...
the terminal. Nothing else in video_production_agent knows the difference -
...
PROMPTS_DIR = Path(__file__).resolve().parent.parent.parent / "video_production_agent" / "_manual_prompts"
